...
* Distributed ACID Transactions in xref:cxx-sdk:howtos:distributed-acid-transactions-from-the-sdk.adoc[{cpp}], 
xref:dotnet-sdk:howtos:distributed-acid-transactions-from-the-sdk.adoc[.NET (C#)], 
xref:go-sdk:howtos:distributed-acid-transactions-from-the-sdk.adoc[.NET (Go)], 
xref:java-sdk:howtos:distributed-acid-transactions-from-the-sdk.adoc[.NET (Java)], 
xref:kotlin-sdk:howtos:distributed-acid-transactions-from-the-sdk.adoc[.NET (Kotlin)], 
xref:nodejs-sdk:howtos:distributed-acid-transactions-from-the-sdk.adoc[.NET (Node.js)], 
xref:php-sdk:howtos:distributed-acid-transactions-from-the-sdk.adoc[.NET (PHP)], 
xref:python-sdk:howtos:distributed-acid-transactions-from-the-sdk.adoc[.NET (Python)], 
and xref:scala-sdk:howtos:distributed-acid-transactions-from-the-sdk.adoc[.NET (Scala)].
* Field Level Encryption pages for 
xref:cxx-sdk:howtos:encrypting-using-sdk.adoc[{cpp}], 
...
// xref:kotlin-sdk:howtos:encrypting-using-sdk.adoc[Kotlin], 
...
// xref:kotlin-sdk:howtos:slow-operations-logging.adoc[Kotlin], 
...
// xref:rust-sdk:howtos:slow-operations-logging.adoc[Rust], 

...
// and made into a :page-partial: - and xrefs made absolute.
// include:7.0@server:learn:data/transactions.adoc[]
...
|Request-level parameters when using queries within transactions. See xref:server:n1ql:n1ql-language-reference/transactions.adoc#settings-and-parameters[] for details.

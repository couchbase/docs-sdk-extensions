...
TIP: Couchbase Distributed ACID Transactions were initially implemented as a separate library. For all of the SDKs listed above they are now fully integrated into the SDK.

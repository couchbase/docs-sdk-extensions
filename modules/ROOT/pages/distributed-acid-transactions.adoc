...
ATRs are created and maintained automatically and are easily distinguishable by their prefix `{txn-atr}`. They are viewable and _should not be modified externally_.
